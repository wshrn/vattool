...
mod machine_uid {
  ...
  pub fn get() -> Result<String, std::io::Error> {
    #[cfg(target_os = "windows")]
    {
      ...
      let mut buffer = vec![0u16; MAX_COMPUTERNAME_LENGTH + 1];
      ...
      if success != 0 {
        ...
        let name = U16CStr::from_slice_with_nul(&buffer)
    ...
    Err(std::io::Error::new(std::io::ErrorKind::NotFound, "no machine id"))
  }
}
